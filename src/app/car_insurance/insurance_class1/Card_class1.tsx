...
import IC1 from '../../../image/autoinsurance/class_11.png'
import IC2 from '../../../image/autoinsurance/class_22.png'
import IC3 from '../../../image/autoinsurance/class_33.png'
...
export default function Card_class1() {
                                ...
                                <div style={{ position: 'relative', width: 'fit-content', margin: 'auto', marginTop: '80px' }}>
                                    ...
                                    <Card className={classes.card2} sx={{ backgroundColor: '#fbd3d2' }} >
                                        ...
                                        <Typography sx={{
                                            ...
                                            ถ้าผ่อนรถอยู่แล้วเกิดอุบัติเหตุ อาจทำให้มีภาระทางการเงินเพิ่มขึ้น การซื้อประกันรถยนต์ชั้น 1 จะช่วยลดความกังวล และคุ้มครองคุณทั้งจากรถชนรถ หรือรถชนแบบไม่มีคู่กรณีได้
                                        </Typography>
                                    </Card>
                                </div>
