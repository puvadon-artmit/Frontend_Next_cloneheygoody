...
import b2 from '../../../image/background/istock1.png'
...
export default function Compare_class3() {
    ...
    return (
        ...
        <Box sx={{ width: '100%', background: 'linear-gradient(to right, #1e3a8a, #1e3faa)', height: 'auto', marginTop: '60px' }}>
            {!isMobile && (
                <Image src={b2} width={255} height={255} style={{
                    position: 'absolute',
                    top: '138%',
                    left: '94.8%',
            ...
            <Container maxWidth="lg" >
                ...
                >
                    ...
                    >
                        ...
                        <tbody>
                            {brands.filter((brand: Brand) => brand.id === 4 || brand.id === 5).map((brand: Brand) => (
