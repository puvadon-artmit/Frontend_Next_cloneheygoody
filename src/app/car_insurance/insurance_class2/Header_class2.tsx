...
import Car from '../../../image/background/car_class_2.png'
...
export default function Header_class2() {
                        ...
                        <Grid container spacing={0} sx={{ marginTop: '60px' }}>
                            ...
                            <Grid item xs={12} md={5}>
                                ...
                                <Box sx={{ whiteSpace: 'pre-line', marginLeft: '160px' }}>
                                    <Typography sx={{ fontSize: '30px', fontWeight: 'bold', color: '#08345c' }}>ซื้อประกันรถยนต์ชั้น 2+/2</Typography>
