...
import b2 from '../../../image/background/b2.png'
import b22 from '../../../image/background/b2+.png'
...
export default function Compare_class2() {
    ...
    return (
        ...
        <Box sx={{ width: '100%', background: 'linear-gradient(to right, #1e3a8a, #1e3faa)', height: 'auto', marginTop: '60px' }}>
            {!isMobile && (
                <Image src={b2} width={155} height={155} style={{
                    position: 'absolute',
                    top: '138%',
                    left: '94.8%',
            ...
            {!isMobile && (
                <Image src={b22} width={155} height={155} style={{
                    position: 'absolute',
                    top: '120%',
                    left: '5%',
                    transform: 'translate(-50%, -50%)',
            ...
            <Container maxWidth="lg" >
                ...
                <Typography textAlign="start" sx={{ fontSize: '30px', color: 'white', fontWeight: 'bold' }}>
                    ประกันรถยนต์ ชั้น 2+ และ 2 ต่างกันยังไง?
                </Typography>
                ...
                >
                    ...
                    <Table
                        ...
                        sx={{
                            ...
                            '& tr > *:last-child': {
                                position: 'sticky',
                                bottom: 0,  // เปลี่ยน right เป็น bottom
                    ...
                    >
                        ...
                        <tbody>
                            {brands.filter((brand: Brand) => brand.id === 2 || brand.id === 3).map((brand: Brand) => (
