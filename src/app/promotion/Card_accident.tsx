...
export default function Card_accident() {
    ...
    return (
        ...
        <Grid container spacing={2} className={classes.cardGrid}>
          {travelData && travelData.length > 0 && travelData.slice(0, 6).map((car: any) => (
            car.attributes.promotion_types?.data[0]?.attributes?.type_pm === "ประกันอุบัติเหตุ" && (
