...
// IMAGE
import Toyota from '../../image/brand_van/toyota.jpg'
import Isuzu from '../../image/brand_van/isuzu.jpg'
import Nissan from '../../image/brand_van/nissan.jpg'
import Mitsu from '../../image/brand_van/missu.jpg'
import Mazda from '../../image/brand_van/mazda.jpg'
import Ford from '../../image/brand_van/ford.jpg'
import Hyu from '../../image/brand_van/hyu.jpg'
...
// JSON DATA
import FordDATA from '../data/Van/ford_van.json';
import HyundaiDATA from '../data/Van/hyundai_van.json';
import IsuzuDATA from '../data/Van/isuzu_van.json';
import MazdaDATA from '../data/Van/mazda_van.json';
import MitsubishiDATA from '../data/Van/mitsubishi_van.json';
import NissanDATA from '../data/Van/nissan_van.json';
import ToyotaDATA from '../data/Van/toyota_van.json';
...
export default function Van_brand() {
    ...
    const handleImageClick = (selectedDrand: string) => {
        setBrand(selectedDrand);
    };
        ...
        <Container>
            <ThemeProvider theme={theme}>
                    ...
                    <Grid item xs={10} sm={8}>
                        <Grid container spacing={2} justifyContent="center" alignItems="center">
                            ...
                            <Grid item xs={4} sm={2}>
                                ...
                                >
                                    <Image src={Mitsu} alt="Your Image" width={100} height={100} />
                                </Paper>
                            </Grid>
                        ...
                        <Grid container spacing={2} justifyContent="center" alignItems="center" sx={{ marginTop: '2.5px' }}>
                            ...
                            <Grid item xs={4} sm={2}>
                                ...
                                >
                                    <Image src={Ford} alt="Your Image" width={100} height={100} />
                                </Paper>
                            </Grid>
                            <Grid item xs={4} sm={2}>
                                <Paper
                ...
                >
                    ...
                    {(brand === 'FORD' || brand === 'HYUNDAI' || brand === 'ISUZU' || brand === 'MAZDA' || brand === 'MITSUBISHI' || brand === 'NISSAN' || brand === 'TOYOTA') && (
                    ...
                    {/* <div style={{ color: 'black', marginTop: '80px' }}>
